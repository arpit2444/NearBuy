...
// this function returns middle section of footer.
      ...
      >
        ...
        >
          <Stack justify={"flex-start"} align={"flex-start"}>
            <Stack>
              <Text cursor={"pointer"} fontWeight={"500"} fontSize={"14px"}>
                Company
              </Text>
          ...
          <Stack
            ...
            mt={{ base: "10px", sm: "10px", md: "0px", lg: "0px" }}
          >
            <Stack>
              <Text cursor={"pointer"} fontWeight={"500"} fontSize={"14px"}>
                Help
        ...
        <Stack
          ...
          mt={{ base: "15px", sm: "15px", md: "0px", lg: "0px" }}
        >
          <Stack>
            <Text fontWeight={"500"} fontSize={"14px"} mb={"5px"}>
              Download app
            </Text>
            ...
            <HStack w={"100%"} pb={"10px"}>
              <VStack cursor={"pointer"}>
                <Image
                  w={"120px"}
                  src="/HomeImages/google-play-badge.svg"
