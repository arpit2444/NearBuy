...
export const LocationPanel = ({ boolean = true }) => {
    ...
    return (
        <>
            <HStack cursor={"pointer"} onClick={onOpen} justify={"center"} align={"center"}>
                ...
                {boolean && <HStack bg={"whiteAlpha.700"} m={"0px 10px"} fontWeight={boolean ? "400" : "500"} border={boolean ? "1px solid gray" : "none"} borderRadius={"20px"} p={"3px 13px"}>
                    <Text>{city}</Text>
                    <TfiArrowCircleDown />
                </HStack>}
                    ...
                    <DrawerBody>
                        ...
                        <Box w={"100%"} minH={"65vh"} position={"relative"}>
                            ...
                            <Stack m={"auto"} maxW={"1272px"}>
                                ...
                                <VStack color={"gray.500"} p={"5px"} position={"relative"} m={"15px 0px"}>

                                    <Text fontSize={"20px"} fontWeight={"500"} color={"black"}>Pick a City</Text>
                                    <Text>To find awesome offers around you</Text>

                                    <VStack justify={"center"} align={"center"} cursor={"pointer"} onClick={onClose} color={"gray.500"} position={"absolute"} top={"10px"} right={"25px"}>
                                        <RxCross1 />
                                ...
                                <Box>
                                    <HStack color={"#ef6864"} justify={"flex-start"} align={"center"} className={"LocationPanel"}>
                                        <HStack justify={"space-between"} align={"center"} className="LocationBoxPanel">
                                            <IoLocationSharp />
                                            <input value={search} onChange={handleChange} className="LocationInputPanel " type={"text"} placeholder={"Enter your city name"} />
                                        </HStack>
                                        <HStack className="LocationButtonPanel">
                                            <FaLocationArrow />
                                            <UnorderedList m={"0px"} p={"0px"} display={{ base: "none", sm: "block", md: "block", lg: "block" }}>
                                                <Text>{city}</Text>
                                            </UnorderedList>
                                        </HStack>
                                    </HStack>
                                ...
                                <Box p={"20px 5px"}>
                                    <HStack m={"auto"}>
                                        <Text fontSize={"18px"} color={"gray.500"}><BsBuilding /></Text>
                                        <Text cursor={"pointer"} fontWeight={"500"} onClick={() => setSuggestions([])}>Top Cities</Text>
                                    </HStack>

                                    <Box display={"flex"} flexDir={"row"} flexWrap={"wrap"} justifyContent={{ base: "space-between", sm: "flex-start", md: "flex-start", lg: "flex-start" }} alignItems={"center"} mt={"10px"}>
                            ...
                            <Stack justify={"center"} align={"center"} m={"auto"} w={"100%"} position={"absolute"} bottom={"0px"}>

                                <HStack justify={"center"} align={"center"} m={"auto"} w={"100%"} mb={"20px"}>
