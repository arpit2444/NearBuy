...
export const Sidebar = () => {
    ...
    return (
        <>
            <Button ref={btnRef} bg={"#ef534e"} color={"white"} onClick={onOpen} mr={"10px"}>
                <RxHamburgerMenu />
            </Button>
            <Drawer
                isOpen={isOpen}
            ...
            >
                ...
                <DrawerContent>
                    ...
                    <DrawerBody fontSize={"14px"} fontWeight={"500"} w={"100%"} mb={"20px"}>
...

                        {
                            !user ? (<Stack mt={"30px"}>
                                <Authentication/>
                                <Text cursor={"pointer"} color={"#ef6864"}>2. We're hiring!</Text>
                                <Text cursor={"pointer"}>3. How it Works</Text>
                                <Text cursor={"pointer"}>4. List your Business</Text>
                            </Stack>) : (<Stack mt={"30px"}>
                                <Button bg={"none"} _hover={{ bg: "none" }} _active={{ bg: "none" }} fontWeight={"500"} fontSize={"11px"} as={Button} rightIcon={<FaUserCircle />}>My Account</Button>
                                ...
                                <Text cursor={"pointer"} onClick={handleLogOut}>Sign Out</Text>
                            </Stack>)
                        }
                    </DrawerBody>
