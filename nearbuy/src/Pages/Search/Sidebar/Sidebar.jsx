...
{/* <span >+ View More</span> */}
    ...
    <div className='sideInputDiv'>   <div>  
     ...
     <div className='sideInputDiv'> <div>  
        ...
        <label>Jangpura Extension</label>  </div>     <span>(1)</span>  </div>
